    ...
    <div>
      <div className='main'>
        <div className="column1">
          <h2>Products</h2>
          <ul>
            <li onClick={() => handleGenreChange('All')}>All Merchandise</li>
            <li onClick={() => handleGenreChange('Pens')}>Pens</li>
            <li onClick={() => handleGenreChange('Clothing')}>Clothing</li>
        ...
        <div className="column2" style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '20px' }}>
          ...
          <div style={{ textAlign: 'center', gridColumn: '1' }}>
            <h1>{selectedGenre === 'All' ? 'All Merchandise' : selectedGenre}</h1>
          </div>
          <br />
